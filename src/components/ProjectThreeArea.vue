<template>
  <section class="top-products-area product-3-area">
    <div class="container-fluid p-0">
      <div class="row">
        <div class="col-lg-12">
          <div class="top-products-title text-center">
            <h3 class="title">Our recent projects</h3>
          </div>
        </div>
      </div>
      <div class="row top-products-active">
        <swiper :options="swiperOptions">
          <swiper-slide>
          <div class="top-products-item mt-30">
            <div class="top-products-thumb">
